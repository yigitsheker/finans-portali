...
import { getTechnicalAnalysis, type TechnicalAnalysisResponse } from "../api/portfolioApi";

type Props = {
    symbol: string;
    period: string; // "1D", "5D", "30D", "1Y"
};

export default function TechnicalAnalysisPanel({ symbol, period }: Props) {
