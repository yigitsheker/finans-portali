...
type AlertType = "PRICE_ABOVE" | "PRICE_BELOW" | "PERCENT_GAIN" | "PERCENT_LOSS";
...
export default function PriceAlertModal({ open, onClose, keycloak, prefilledSymbol, prefilledPrice }: Props) {
    ...
    const getStatusColor = (alert: AlertView) => {
