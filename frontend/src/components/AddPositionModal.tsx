...
import { upsertPosition, type UpsertPositionRequest } from "../api/portfolioApi";
import type Keycloak from "keycloak-js";

type Props = {
    open: boolean;
    onClose: () => void;
    onCreated: () => void; // listeyi refresh etmek için
    keycloak: Keycloak;
};

export default function AddPositionModal({ open, onClose, onCreated, keycloak }: Props) {
