// Shared line-style icon set (Feather/Lucide), replacing emoji that rendered
// inconsistently across platforms. Every icon is a single React component that
// inherits color via `currentColor` and accepts a `size` prop (default 16) plus
// any extra SVG props (style, className, onClick…).
//
// Usage:  import { IconSearch } from "../common/icons";
...
export const IconLightbulb = (p) => (
  <Svg {...p}>
    <path d="M9 18h6" />
    <path d="M10 22h4" />
    <path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2 .8 3 .7 1 1.4 1.5 1.7 2.5" />
  </Svg>
);
...
export const IconFlask = (p) => (
  <Svg {...p}>
    <path d="M9 3h6" />
    <path d="M10 3v6.5L5.2 18a2 2 0 0 0 1.8 3h10a2 2 0 0 0 1.8-3L14 9.5V3" />
...
export const IconCrown = (p) => (
  <Svg {...p}>
    <path d="M3 6l4 3 5-6 5 6 4-3-2 12H5L3 6z" />
