...
const TYPE_LABELS: Record<DebtInstrumentType, string> = {
...
export default function Bonds({ keycloak }: Props) {
    ...
    // Filters
    const [typeFilter, setTypeFilter] = useState<DebtInstrumentType | "ALL">("ALL");
    const [currencyFilter, setCurrencyFilter] = useState<string | "ALL">("ALL");
    const [search, setSearch] = useState("");
    
    // Selected bond for detail modal
    const [selectedBond, setSelectedBond] = useState<BondListItem | null>(null);
